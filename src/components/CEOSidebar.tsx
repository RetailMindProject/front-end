...
export default function CEOSidebar({ open, onToggle }: { 
  ...
  return (
    <aside className={`${open ? "w-64" : "w-16"} sticky top-0 h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 border-r border-gray-300 transition-all duration-300 ease-in-out relative flex flex-col`}>
