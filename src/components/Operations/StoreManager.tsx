...
interface StoreManagerProps {
  ...
  onAddFromInventory: (product: Product) => void;
}

const StoreManager = ({ storeProducts, inventoryProducts, onDelete, onAddFromInventory }: StoreManagerProps) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border">
      ...
      <ConfirmDeleteModal
        ...
        message={`Remove "${deleteConfirm.productName}" from the store? Customers will no longer see this product.`}
      />
    </div>
  );
};
